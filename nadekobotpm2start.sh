...
if [ $choice -eq 1 ] ; then
	echo ""
	wget -N https://github.com/Madmanmayson/NadekoBot-BashScript/raw/1.9/NadekoARN.sh 
	cd "$root"
	...
	if [ $choice -eq 2 ] ; then
		echo ""
		wget -N https://github.com/Madmanmayson/NadekoBot-BashScript/raw/1.9/NadekoARU_Latest.sh 
		cd "$root"
		...
		if [ $choice -eq 3 ] ; then
		echo ""
		wget -N https://github.com/Madmanmayson/NadekoBot-BashScript/raw/1.9/nadeko_run.sh
		cd "$root"
