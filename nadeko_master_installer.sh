...
if [ $choice -eq 1 ] ; then
	...
	wget -N https://github.com/Madmanmayson/NadekoBot-BashScript/raw/1.9/nadeko_installer_latest.sh && bash "$root/nadeko_installer_latest.sh"
	echo ""
	bash "$root/linuxAIO.sh"
		...
		if [ $choice -eq 2 ] ; then
			...
			wget -N https://github.com/Madmanmayson/NadekoBot-BashScript/raw/1.9/nadeko_run.sh && bash "$root/nadeko_run.sh"
			echo ""
			...
			if [ $choice -eq 3 ] ; then
				...
				sleep 5s
				wget -N https://github.com/Madmanmayson/NadekoBot-BashScript/raw/1.9/NadekoAutoRestartAndUpdate.sh && bash "$root/NadekoAutoRestartAndUpdate.sh"
				echo ""
				...
				if [ $choice -eq 4 ] ; then
					...
					wget -N https://github.com/Madmanmayson/NadekoBot-BashScript/raw/1.9/nadekoautoinstaller.sh && bash "$root/nadekoautoinstaller.sh"
					echo ""
					echo "Welcome back..."
					sleep 2s
					bash "$root/linuxAIO.sh"
...
bash "$root/linuxAIO.sh"
						...
						wget -N https://github.com/Madmanmayson/NadekoBot-BashScript/raw/1.9/nadekopm2setup.sh && bash "$root/nadekopm2setup.sh"
						echo ""
						echo "Welcome back..."
						sleep 2s
						bash "$root/linuxAIO.sh"	
							...
							wget -N https://github.com/Madmanmayson/NadekoBot-BashScript/raw/1.9/nadekobotpm2start.sh && bash "$root/nadekobotpm2start.sh"
							echo ""
							sleep 2s
							bash "$root/linuxAIO.sh"
							else
